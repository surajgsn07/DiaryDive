...
<div id="content" style="border: 1px solid white; margin: 3vh; border-radius: 3vh;">
    <?php
    // Ensure that your database connection ($conn) is correctly established before this point

    // Avoid SQL injection by using prepared statements
    $sql = "SELECT theme, user, date, content FROM blogs WHERE category = ?";
    
    if ($stmt = mysqli_prepare($conn, $sql)) {
        // Bind the category parameter
        $category = "sport and adventure";
